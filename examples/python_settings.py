# -*- encoding: utf-8 -*-
'''
@Time     :   2025/12/01 23:17:28
@Author   :   QuYue
@File     :   python_settings.py
@Email    :   quyue1541@gmail.com
@Desc:    :   python_settings
'''
...
if __name__ == "__main__":
    # Step 1. Initialize GDriveTools with settings.yaml file
    """
    ...
    local_files = ['./examples/python_settings.py', './settings.yaml'] # If you want to upload multiple files, use a list of strings.
